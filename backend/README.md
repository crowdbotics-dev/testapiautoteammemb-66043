...
## Project Structure
    ...
    ├── testapiautoteammemb_66043  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_66043`
...
2. Clone this repo and `cd testapiautoteammemb_66043`
